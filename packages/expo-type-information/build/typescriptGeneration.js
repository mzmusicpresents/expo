...
const numberKeywordType = () => typescript_1.default.factory.createKeywordTypeNode(typescript_1.default.SyntaxKind.NumberKeyword);
...
const BASIC_TYPE_MAP = {
    [typeInformation_types_1.BasicType.ANY]: typescript_1.default.SyntaxKind.AnyKeyword,
    [typeInformation_types_1.BasicType.BOOLEAN]: typescript_1.default.SyntaxKind.BooleanKeyword,
    [typeInformation_types_1.BasicType.NUMBER]: typescript_1.default.SyntaxKind.NumberKeyword,
    [typeInformation_types_1.BasicType.STRING]: typescript_1.default.SyntaxKind.StringKeyword,
    [typeInformation_types_1.BasicType.VOID]: typescript_1.default.SyntaxKind.VoidKeyword,
    [typeInformation_types_1.BasicType.UNDEFINED]: typescript_1.default.SyntaxKind.UndefinedKeyword,
    [typeInformation_types_1.BasicType.NEVER]: typescript_1.default.SyntaxKind.NeverKeyword,
    [typeInformation_types_1.BasicType.OBJECT]: typescript_1.default.SyntaxKind.ObjectKeyword,
    [typeInformation_types_1.BasicType.UNRESOLVED]: typescript_1.default.SyntaxKind.UndefinedKeyword, // This is handled separately
};
function mapBasicTypeToTypeNode(basicType) {
    if (basicType === typeInformation_types_1.BasicType.UNRESOLVED) {
...
const CONVERTIBLE_TYPE_MAP = {
    [typeInformation_types_1.ConvertibleType.COLOR]: () => typescript_1.default.factory.createTypeReferenceNode('ColorValue'),
    [typeInformation_types_1.ConvertibleType.UINT8_ARRAY]: () => typescript_1.default.factory.createTypeReferenceNode('Uint8Array'),
    // TODO(@HubertBer): Maybe also consider [x, y] type
    [typeInformation_types_1.ConvertibleType.CG_POINT]: () => typescript_1.default.factory.createTypeLiteralNode([
    ...
    [typeInformation_types_1.ConvertibleType.CG_SIZE]: () => typescript_1.default.factory.createTypeLiteralNode([
    ...
    // TODO(@HubertBer): Maybe also consider the array version
    [typeInformation_types_1.ConvertibleType.CG_VECTOR]: () => typescript_1.default.factory.createTypeLiteralNode([
        createPropertySignature({ name: 'dx', typeNode: numberKeywordType() }),
        createPropertySignature({ name: 'dy', typeNode: numberKeywordType() }),
    ]),
    // TODO(@HubertBer): Maybe also consider the array version
    [typeInformation_types_1.ConvertibleType.CG_RECT]: () => typescript_1.default.factory.createTypeLiteralNode([
        createPropertySignature({ name: 'x', typeNode: numberKeywordType() }),
        createPropertySignature({ name: 'y', typeNode: numberKeywordType() }),
        createPropertySignature({ name: 'width', typeNode: numberKeywordType() }),
        createPropertySignature({ name: 'height', typeNode: numberKeywordType() }),
    ]),
    [typeInformation_types_1.ConvertibleType.JS_FUNCTION]: () => createAnyFunctionTypeNode({ returnType: anyKeywordType() }),
};
function mapConvertibleTypeToTypeNode(convertibleType) {
...
function mapTypeToTsTypeNode(type) {
    switch (type.kind) {
        ...
        case typeInformation_types_1.TypeKind.CONVERTIBLE:
            return mapConvertibleTypeToTypeNode(type.type);
        ...
        case typeInformation_types_1.TypeKind.OPTIONAL:
            return typescript_1.default.factory.createUnionTypeNode([
                ...
                mapBasicTypeToTypeNode(typeInformation_types_1.BasicType.UNDEFINED),
            ]);
    ...
    return mapBasicTypeToTypeNode(typeInformation_types_1.BasicType.UNRESOLVED);
}
//
...
function buildRecordTypeAlias(recordType, exported) {
    return createTypeAlias({
        ...
        type: typescript_1.default.factory.createTypeLiteralNode(recordType.fields.map((field) => {
            const optional = field.type.kind === typeInformation_types_1.TypeKind.OPTIONAL;
...
function createAnyFunctionTypeNode({ returnType }) {
